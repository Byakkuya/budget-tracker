                    ...
                    {dataAvailable && (
                        ...
                        >
                            ...
                            barCategoryGap={5}>
                                ...
                                <CustomTooltip formatter={formmater} {...props}/>
                            </BarChart>
                        </ResponsiveContainer>
                    ...
                    (
                        <Card className='flex h-[300px] flex-col items-center justify-center bg-background'>
                            ...
                            <p className='text-sm text-muted-foreground'>
                                Try selecting a different date range or try adding new transactions
                            </p>
                        </Card>
                    )}
                </SkeletonWrapper>
...
function TooltipRow({label, value, bgColor, textColor, formatter}: any) {
    return (
